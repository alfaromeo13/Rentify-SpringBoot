...
public class NeighborhoodController {
    ...
    public ResponseEntity<List<NeighborhoodDTO>> findByCityAndNeighborhoodName(
            @RequestParam String cityName, @RequestParam String neighborhoodName, Pageable pageable) {
